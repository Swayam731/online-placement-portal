<%-- 
    Document   : searching
    Created on : 26 Feb, 2023, 11:18:47 AM
    Author     : swayam
--%>
...
<html>
    ...
    <body>
        ...
        <% 
          String tenthpercent =(String)session.getAttribute("tenthpercent");
          String twelthpercent =(String)session.getAttribute("twelthpercent");
        ...
        try
       {
           ...
           String query = "SELECT * FROM studentinfo WHERE 10th_percentage >= '"+tenthpercent+"' AND 12th_percentage >= '"+twelthpercent+"' AND cgpa >= '"+cgpa+"' AND number_of_backlogs <= '"+back+"' ";
